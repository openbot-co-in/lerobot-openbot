...
from . import GiraffeFollower
from .config_giraffe_follower import GiraffeFollowerEndEffectorConfig

logger = logging.getLogger(__name__)
EE_FRAME = "gripper_tip"


class GiraffeFollowerEndEffector(GiraffeFollower):
    """
    GiraffeFollower robot with end-effector space control.

    This robot inherits from GiraffeFollower but transforms actions from
    end-effector space to joint space before sending them to the motors.
    """

    config_class = GiraffeFollowerEndEffectorConfig
    name = "giraffe_follower_end_effector"

    def __init__(self, config: GiraffeFollowerEndEffectorConfig):
        ...
        # Initialize the kinematics module for the giraffe robot
        self.kinematics = RobotKinematics(robot_type="giraffe_new_calibration")
